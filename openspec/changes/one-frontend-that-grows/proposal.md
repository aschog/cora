...
- Three guards: the start command, one run path, and nothing imports Streamlit
...
- `tests/guards/` — Streamlit drops out of five guards, and one new guard bars its return
