...
The story and its criteria are in `openspec/changes/front-door-explains-cora/`.
Written day one, before the code: the retrospective names cutting it last as the cause of
the reviewer seeing it. The sentence is rewritten there and the rest of the README follows
