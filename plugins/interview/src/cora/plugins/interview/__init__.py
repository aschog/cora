...
whatever the cora in front of it offers, which is the check saying yes to everything."""

SCOPE = "interview"
"""What everything here is registered under, the misuse screen included: cora's own
security plugin holds the system-wide line, and this one only knows interviews."""

STYLE = "style"
"""The setting that picks which of the five instruction styles registers —
`CORA_PLUGIN_INTERVIEW_STYLE`. The candidates and their comparison are PROMPTS.md's."""
