...
- **Understand** — [what it is made of](docs/big-picture.md), the engine and its ten
  ...
  runs it · [where your data lives](docs/data-storage.md), the one file and the
  directory beside it · [privacy, and what a plugin costs in
  trust](docs/privacy-and-ethics.md), what leaves your machine and what loading someone
