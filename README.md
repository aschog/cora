...
uv run streamlit run packages/cora-app/src/cora/app/ui/streamlit_app.py
```
...
```sh
uv run --env-file .env streamlit run packages/cora-app/src/cora/app/ui/streamlit_app.py
```
