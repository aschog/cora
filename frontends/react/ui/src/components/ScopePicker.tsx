...
type Props = {
  ...
  fixed: boolean
  /** Whether this is drawn beside the field's own page. Settled, it then draws nothing:
   *  the field is the screen the reader is working in, and a label naming it under a
   *  control they can no longer use is a line the rail has no room for. The control
   *  itself is drawn either way, because picking a field is not naming one. */
  quiet?: boolean
