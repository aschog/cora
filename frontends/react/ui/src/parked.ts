 ...
 *  turn is in no store — so without this the question would be unreachable: CONVERSATIONS
 ...
 *  question is recorded nowhere and listed under no conversation, so clearing the stow while
